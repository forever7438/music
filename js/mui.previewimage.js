(function($, window) {
	...
	proto.open = function(index, group) {
		...
		if(parentWeb){
			// console.log(JSON.stringify(parentWeb))
			mui.fire(parentWeb,'showMaskpic',{});
		//parentWeb.setStyle({mask:"rgba(0,0,0,0.5)"});
		}
	...
	proto.close = function(index, group) {
		...
		var parentWeb = plus.webview.currentWebview().parent();
		if(parentWeb){
			mui.fire(parentWeb,'closeMaskpic',{});
		}
